...
class Persona(ModeloBase):
    ...
    cedula = models.CharField(max_length=10, verbose_name=u"Cédula", blank=True, null=True, db_index=True)
    pasaporte = models.CharField(default='', max_length=20, blank=True, null=True, verbose_name=u"Pasaporte", db_index=True)
    ruc = models.CharField(default='', max_length=13, blank=True, null=True, verbose_name=u"Ruc", db_index=True)
