...
class PlantillaPersonalForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['fecha_ingreso'].widget.attrs.update({'class': 'form-control date', 'col': 'col-md-6', 'type': 'date', 'format': 'dd-mm-yyyy', 'placeholder': 'MM/DD/AA'})
        self.fields['fecha_terminacion'].widget.attrs.update({'class': 'form-control date', 'col': 'col-md-6', 'type': 'date', 'format' : 'dd-mm-yyyy', 'placeholder': 'MM/DD/AA'})
...
class DatosFamiliaresForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['fecha_nacimiento'].widget.attrs.update({'class': 'form-control date', 'col': 'col-md-6', 'type': 'date', 'format' : 'mm-dd-yyyy', 'required':'true', 'placeholder': 'MM/DD/AA'})
